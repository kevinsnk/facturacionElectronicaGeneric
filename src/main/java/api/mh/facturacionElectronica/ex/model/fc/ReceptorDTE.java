...
public class ReceptorDTE {
	...
	@Override
	public int hashCode() {
		return Objects.hash(codActividad, correo, descActividad, direccion, nombre, nrc, numDocumento, telefono,
				tipoDocumento);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(codActividad, other.codActividad) && Objects.equals(correo, other.correo)
				...
				&& Objects.equals(nombre, other.nombre) && Objects.equals(nrc, other.nrc)
