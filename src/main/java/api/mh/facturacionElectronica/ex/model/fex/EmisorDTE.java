...
public class EmisorDTE {
	...
	public int hashCode() {
		return Objects.hash(codActividad, codEstable, codEstableMH, codPuntoVenta, codPuntoVentaMH, correo,
				descActividad, direccion, nit, nombre, nombreComercial, nrc, recintoFiscal, regimen, telefono,
				tipoEstablecimiento, tipoItemExpor);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(codActividad, other.codActividad) && Objects.equals(codEstable, other.codEstable)
				...
				&& Objects.equals(recintoFiscal, other.recintoFiscal) && Objects.equals(regimen, other.regimen)
				&& Objects.equals(telefono, other.telefono)
				&& Objects.equals(tipoEstablecimiento, other.tipoEstablecimiento)
				&& tipoItemExpor == other.tipoItemExpor;
	}
	...
	public String toString() {
		return "EmisorDTE [nit=" + nit + ", nrc=" + nrc + ", nombre=" + nombre + ", codActividad=" + codActividad
				...
				+ codPuntoVentaMH + ", codPuntoVenta=" + codPuntoVenta + ", tipoItemExpor=" + tipoItemExpor
				+ ", recintoFiscal=" + recintoFiscal + ", regimen=" + regimen + "]";
	}
