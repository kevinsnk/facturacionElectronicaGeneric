...
public class IdentificacionDTE {
	...
	@Override
	public int hashCode() {
		return Objects.hash(ambiente, codigoGeneracion, fecEmi, horEmi, motivoContin, numeroControl, tipoContingencia,
				tipoDte, tipoModelo, tipoMoneda, tipoOperacion, version);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(ambiente, other.ambiente) && Objects.equals(codigoGeneracion, other.codigoGeneracion)
				...
				&& Objects.equals(motivoContin, other.motivoContin)
	...
	public String toString() {
		return "IdentificacionDTE [version=" + version + ", ambiente=" + ambiente + ", tipoDte=" + tipoDte
				...
				+ ", motivoContin=" + motivoContin + ", fecEmi=" + fecEmi + ", horEmi=" + horEmi + ", tipoMoneda="
				+ tipoMoneda + "]";
	}
