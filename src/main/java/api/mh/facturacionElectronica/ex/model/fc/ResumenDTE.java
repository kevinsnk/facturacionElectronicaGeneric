...
public class ResumenDTE {
	...
	/*
	 * public BigDecimal getIvaPerci1() { return ivaPerci1; }
	 * 
	 * public void setIvaPerci1(BigDecimal ivaPerci1) { this.ivaPerci1 = ivaPerci1;
	 * }
	 */
	...
	@Override
	public int hashCode() {
		return Objects.hash(condicionOperacion, descuExenta, descuGravada, descuNoSuj, ivaRete1, montoTotalOperacion,
				numPagoElectronico, pagos, porcentajeDescuento, reteRenta, saldoFavor, subTotal, subTotalVentas,
				totalDescu, totalExenta, totalGravada, totalIva, totalLetras, totalNoGravado, totalNoSuj, totalPagar,
				tributos);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(condicionOperacion, other.condicionOperacion)
				...
				&& Objects.equals(descuNoSuj, other.descuNoSuj) && Objects.equals(ivaRete1, other.ivaRete1)
				...
				&& Objects.equals(totalGravada, other.totalGravada) && Objects.equals(totalIva, other.totalIva)
	...
	public String toString() {
		return "ResumenDTE [totalNoSuj=" + totalNoSuj + ", totalExenta=" + totalExenta + ", totalGravada="
				...
				+ ", totalDescu=" + totalDescu + ", tributos=" + tributos + ", subTotal=" + subTotal + ", ivaRete1="
				+ ivaRete1 + ", reteRenta=" + reteRenta + ", montoTotalOperacion=" + montoTotalOperacion + ", totalIva="
				+ totalIva + ", totalNoGravado=" + totalNoGravado + ", totalPagar=" + totalPagar + ", totalLetras="
				+ totalLetras + ", saldoFavor=" + saldoFavor + ", condicionOperacion=" + condicionOperacion + ", pagos="
				+ pagos + ", numPagoElectronico=" + numPagoElectronico + "]";
	}
