...
public class ResumenDTE {
	...
	public int hashCode() {
		return Objects.hash(condicionOperacion, descuExenta, descuGravada, descuNoSuj, ivaPerci1, ivaRete1,
				montoTotalOperacion, numPagoElectronico, reteRenta, subTotal, subTotalVentas, totalDescu, totalExenta,
				totalGravada, totalLetras, totalNoSuj, tributos);
	}
	...
	public String toString() {
		return "ResumenDTE [totalNoSuj=" + totalNoSuj + ", totalExenta=" + totalExenta + ", totalGravada="
				...
				+ totalLetras + ", condicionOperacion=" + condicionOperacion + ", numPagoElectronico="
				+ numPagoElectronico + "]";
	}
