...
public class CuerpoDocumentoDTE {
	...
	public String toString() {
		return "CuerpoDocumentoDTE [numItem=" + numItem + ", tipoItem=" + tipoItem + ", numeroDocumento="
				+ numeroDocumento + ", cantidad=" + cantidad + ", codigo=" + codigo + ", codTributo=" + codTributo
				+ ", descripcion=" + descripcion + ", uniMedida=" + uniMedida + ", precioUni=" + precioUni
				+ ", montoDescu=" + montoDescu + ", ventaNoSuj=" + ventaNoSuj + ", ventaExenta=" + ventaExenta
				+ ", ventaGravada=" + ventaGravada + ", tributos=" + tributos + ", psv=" + psv + ", noGravado="
				+ noGravado + ", ivaItem=" + ivaItem + "]";
	}
