...
public class AnulacionDTEResponse {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AnulacionDTEResponse other = (AnulacionDTEResponse) obj;
	...
	public String toString() {
		return "AnulacionDTEResponse [version=" + version + ", ambiente=" + ambiente + ", versionApp=" + versionApp
				+ ", estado=" + estado + ", selloRecibido=" + selloRecibido + ", fhProcesamiento=" + fhProcesamiento
				+ ", codigoGeneracion=" + codigoGeneracion + ", clasificaMsg=" + clasificaMsg + ", codigoMsg="
				+ codigoMsg + ", descripcionMsg=" + descripcionMsg + ", observaciones=" + Arrays.toString(observaciones)
				+ "]";
	}
